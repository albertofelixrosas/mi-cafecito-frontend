...
type StockEntriesFiltersKeys = 'name';
...
const StockEntries: React.FC = () => {
  ...
  const handleFilterChange = (key: StockEntriesFiltersKeys, value: string | number | undefined) => {
  ...
  return (
    <div className="product-list">
      <header className="product-list__header">
        <h1 className="product-list__title">ENTRADAS</h1>
        ...
        <table className="table">
          ...
          <tbody className="table__body">
            {productCategories.map(category => (
              <tr key={category.productCategoryId} className="table__row">
                <td className="table__cell table__cell--name">{category.productCategoryName}</td>
                <td className="table__cell table__cell--description">{category.description}</td>
                <td className="table__cell">
                  <div className="table__actions">
                    <Link
                      to={`${category.productCategoryId}/editar`}
                    ...
                    <button
                      ...
                      onClick={() => deleteProductCategory(category.productCategoryId)}
                    >
                      <MdDelete />
                    </button>
                  </div>
